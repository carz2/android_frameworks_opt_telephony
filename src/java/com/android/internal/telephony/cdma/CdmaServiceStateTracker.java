...
public class CdmaServiceStateTracker extends ServiceStateTracker {
    ...
    */
    ...
    private boolean getAutoTime() {
        try {
            return Settings.System.getInt(cr, Settings.Global.AUTO_TIME) > 0;
    ...
    private boolean getAutoTimeZone() {
        try {
            return Settings.System.getInt(cr, Settings.Global.AUTO_TIME_ZONE) > 0;
        } catch (SettingNotFoundException snfe) {
            return true;
        }
    }
    ...
    private void revertToNitzTime() {
        if (Settings.System.getInt(cr, Settings.Global.AUTO_TIME, 0) == 0) {
            return;
        }
        if (DBG) {
